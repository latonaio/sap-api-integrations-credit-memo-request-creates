...
import (
	sap_api_caller "sap-api-integrations-credit-memo-request-creates/SAP_API_Caller"
	sap_api_input_reader "sap-api-integrations-credit-memo-request-creates/SAP_API_Input_Reader"
	"sap-api-integrations-credit-memo-request-creates/config"
...
func main() {
	...
	inputSDC := fr.ReadSDC("./Inputs/SDC_Credit_Memo_Request_Header_Item_sample.json")
	...
	caller.AsyncPostCreditMemoRequest(
		headerItem,
		accepter,
	)
}
